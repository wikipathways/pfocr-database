...
pmcid: PMC4419338
papertitle: 'Going with the flow: How shear stress signals the emergence of adult
  hematopoiesis.'
reftext: David Traver. J Exp Med. 2015 May 4;212(5):600-600.
pmc_ranked_result_index: '62759'
...
schema-jsonld:
  ...
  '@id': https://pfocr.wikipathways.org/figures/PMC4419338__JEM_2125insight4_Fig2.html
  '@type': Dataset
  description: Model of flow-induced signal transduction events. Shear force induces
    signaling events that are orchestrated by the cAMP–PKA–CREB pathway to produce
    PGE2, adenosine, and BMP, which drive HSC production.
  license: CC0
  name: CreativeWork
  creator:
    '@type': Organization
