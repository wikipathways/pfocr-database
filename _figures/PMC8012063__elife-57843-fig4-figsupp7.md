...
schema-jsonld:
  ...
  '@id': https://pfocr.wikipathways.org/figures/PMC8012063__elife-57843-fig4-figsupp7.html
  '@type': Dataset
  description: The signal is mainly driven by the differential expression of the mitochondrial
    respiratory chain. Green/red color depicts the cross-tissue log2-fold-change (see
    legend for scale) with direction breeder/non-breeder.
  license: CC0
  name: CreativeWork
