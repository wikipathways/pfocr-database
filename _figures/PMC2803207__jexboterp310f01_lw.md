...
schema-jsonld:
  ...
  '@id': https://pfocr.wikipathways.org/figures/PMC2803207__jexboterp310f01_lw.html
  '@type': Dataset
  description: Simplified representation of the D-mannose/L-galactose L-ascorbic acid
    biosynthetic pathway in higher plants. Enzymes are (1) phosphoglucose isomerase,
    (2) phosphomannose isomerase (3), phosphomannose mutase (PMM), (4) GDP-mannose
    pyrophosphorylase (VTC1), (5) GDP-mannose-3′,5′-epimerase, (6) GDP-L-galactose
    phosphorylase (VTC2/VTC5), (7) L-galactose-1-phosphate phosphatase (VTC4), (8)
    L-galactose dehydrogenase, (9) L-galactono-1,4-lactone dehydrogenase. (Adapted
    from .)
  license: CC0
  name: CreativeWork
  creator:
