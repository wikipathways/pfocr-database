...
schema-jsonld:
  ...
  '@id': https://pfocr.wikipathways.org/figures/PMC2895278__Fig4_REVGuengerich.html
  '@type': Dataset
  description: Latter steps of postulated pathway for synthesis of morphine, based
    on studies with plants. See (–).
  license: CC0
  name: CreativeWork
  creator:
    '@type': Organization
