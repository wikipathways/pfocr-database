...
schema-jsonld:
  ...
  '@id': https://pfocr.wikipathways.org/figures/PMC2742090__cshperspect-GRA-a002014fig4.html
  '@type': Dataset
  description: Negative feedback loops in the SHH signaling pathway driven by SHH-binding
    proteins. The membrane proteins Gas1, Cdo, and Boc promote the activation of Smo
    and are transcriptionally inhibited by SHH signaling. Conversely, Ptc1 and Hhip1
    are transcriptionally induced by Gli activation and inhibit the transduction of
    a SHH signal to Smo.
